...
scene_suffix\: | satellite image:<zero-width space>-1:-.95 | text:<zero-width space>-1:-.95 | watermark:<zero-width space>-1:-.95 | backyard telescope:<zero-width space>-1:-.95 | map:<zero-width space>-1:-.95
